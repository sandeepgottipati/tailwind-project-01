  ...
  return (
    <div className="bg-violet-600 rounded-xl text-white ">
      <div className="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
        ...
        <h2 className="font-serif text-center mt-5  text-2xl">200GB</h2>
        <h3 className="text-center  font-light mt-2 text-xs">$3.99/month</h3>
        <div className="flex justify-center">
          <a
            href="#"
            className="inline-block px-10 py-3 my-8 text-center bg-violet-600 border border-violet-600 rounded-lg duration-200 hover:bg-violet-800 hover:border-violet-800"
          >
            Purchase
          </a>
        </div>
